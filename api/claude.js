...
//        sous "Prescription NON CONFORME"). Remplacé par claude-sonnet-4-6.
//        ⚠️ Choix délibéré : Sonnet 4.6 accepte `temperature: 0` (déterminisme requis
//        ici) ; NE PAS migrer vers Sonnet 5 tel quel — il rejette les paramètres de
//        sampling non par défaut (le `temperature: 0` provoquerait un 400).
// V4.3 — 2026-03-28
// FIXES :
